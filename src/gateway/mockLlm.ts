 ...
 * hurts nobody but the party doing it. See TECHNICAL_DESIGN.md §3.3.
 */
 ...
 * TECHNICAL_DESIGN.md §3.2. The Charge gateway must be able to guarantee it
