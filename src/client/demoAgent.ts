...
// same reasoning as src/client/demo.ts (see TECHNICAL_DESIGN.md §6.2): the
...
async function main() {
  ...
  console.log("was generated — see TECHNICAL_DESIGN.md §3.2 for why that ordering is the whole point.");
}
